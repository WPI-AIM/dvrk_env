...
public:
  dvrk_gazebo_control(ros::NodeHandle n){
    ecmPub.resize(4);
    ecmPub[0]=n.advertise<std_msgs::Float64>("/dvrk/ecm/yaw_joint/SetPosition",10);
    ecmPub[1]=n.advertise<std_msgs::Float64>("/dvrk/ecm/pitch_front_joint/SetPositionTarget",10);
    ecmPub[2]=n.advertise<std_msgs::Float64>("/dvrk/ecm/main_insertion_joint/SetPosition",10);
    ecmPub[3]=n.advertise<std_msgs::Float64>("/dvrk/ecm/tool_joint/SetPosition",1000);


    psm1Pub.resize(5);
    psm1Pub[0]=n.advertise<std_msgs::Float64>("/dvrk/PSM1/outer_yaw_joint/SetPosition",10);
    psm1Pub[1]=n.advertise<std_msgs::Float64>("/dvrk/PSM1/outer_pitch_joint_1/SetPositionTarget",10);
    psm1Pub[2]=n.advertise<std_msgs::Float64>("/dvrk/PSM1/outer_insertion_joint/SetPosition",10);
    ...
    psm2Pub.resize(5);
    psm2Pub[0]=n.advertise<std_msgs::Float64>("/dvrk/PSM2/outer_yaw_joint/SetPosition",10);
    psm2Pub[1]=n.advertise<std_msgs::Float64>("/dvrk/PSM2/outer_pitch_joint_1/SetPositionTarget",10);
    psm2Pub[2]=n.advertise<std_msgs::Float64>("/dvrk/PSM2/outer_insertion_joint/SetPosition",10);
